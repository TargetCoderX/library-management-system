            ...
            <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
                ...
                <div>
                    <a className="navbar-brand brand-logo" href="../../index.html">
                        <Image src={logo} alt="logo" style={{ height: '60px' }} height={200} width={60} />
                    </a>
            ...
            <div className="navbar-menu-wrapper d-flex align-items-top">
                <ul className="navbar-nav">
                    <li className="nav-item fw-semibold d-none d-lg-block ms-0">
                        {cookiesData.user && (
                            <h1 className="welcome-text">{cookiesData.dayNight >= 0 && cookiesData.dayNight <= 12 ? `Good Morning` : `Good Evening`}, <span className="text-black fw-bold">{cookiesData.user.name.charAt(0).toUpperCase() + cookiesData.user.name.substr(1).toLowerCase()}</span></h1>
                        )}
                        <h3 className="welcome-sub-text">We're thrilled to have you here.</h3>
                    </li>
                </ul>
                <ul className="navbar-nav ms-auto">
                    ...
                    <li className="nav-item dropdown d-none d-lg-block user-dropdown">
                        <a className="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                            <Image className="img-xs rounded-circle" height={100} width={100} src={avatar} alt="Profile image" /> </a>
                        <div className="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                            ...
                            <Link className="dropdown-item" href={'/login'} onClick={(e) => signout(e)} ><i className="dropdown-item-icon mdi mdi-power text-primary me-2"></i>Sign Out</Link>
                        </div>
                    </li>
                </ul>
